...
test("server 2019 release builder parses as valid powershell", { skip: process.platform !== "win32" }, () => {
  const root = process.cwd();
  const script = path.join(root, "scripts", "build-server-2019-release.ps1");
