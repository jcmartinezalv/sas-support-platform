param(
  ...
  [string]$PackageName = "sas-server-2019-release",
...
$includeDirs = @("src", "public", "scripts", "docs", "client")
...
@"
SAS Server 2019 Release
Generated: $(Get-Date -Format o)

Destino sugerido en servidor:
  C:\SAS\Release
...
"@ | Set-Content -Path (Join-Path $outDir "SERVER-2019-README.txt") -Encoding UTF8
...
$manifest = [pscustomobject]@{
  ...
  Target = "Windows Server 2019 Standard"
...
[pscustomobject]@{
  ...
  readme = (Join-Path $outDir "SERVER-2019-README.txt")
